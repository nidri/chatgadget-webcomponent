(function () {
  ...
  class ChatWidget extends HTMLElement {
    ...
    connectedCallback() {
      ...
      const chatLauncher = this.shadowRoot.querySelector(
        ".chat-widget-launcher",
      );
      const chatCloseIcon = this.shadowRoot.querySelector(
        ".chat-widget-close-icon",
      );
      ...
      this.addEventListener(
        "chat-widget-activate",
        this._activateChatWidget,
        false,
      );
      this.addEventListener(
        "chat-widget-expand",
        this._expandChatWidget,
        false,
      );
      this.addEventListener(
        "chat-widget-collapse",
        this._collapseChatWidget,
        false,
      );
    }
    ...
    _handleCurrentMessage() {
      ...
      this.dispatchEvent(
        new CustomEvent("chat-message-send", {
          bubbles: true,
          detail: { message: msgInput.value },
        }),
      );
      msgInput.value = "";
    }
    ...
    _toggleChatWidget(event) {
      ...
      this.shadowRoot
        .querySelector(".chat-widget-launcher")
